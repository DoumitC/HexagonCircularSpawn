...
public class HexBase6 extends JPanel{
    ...
    public HexBase6(String COLOR, int HexNum){
    ...
    public void paintComponent(Graphics g){
        ...
        super.paintComponent(g);
            ...
            int RegPatternNeeded = 5;
            int SidePatternNeeded = 2;
            int xIncrement = -HexagonWidth/2;
            int yIncrement = 3*HexagonHeight/4;           
            int HexagonCtr = 0;

            //Creating Base 6 Template
            ...
            //Smaller Circle Start Hard Code
        
        int xMainCoord = 5*HexagonWidth/2;
        int yMainCoord = 0;
            
        int OGx = xMainCoord; //Maybe remove


        for(int j = 0; j<(HexagonNumber-6);j++){
            int[] xPoints = {HexagonWidth,HexagonWidth,HexagonWidth/2,0,0,HexagonWidth/2};
            int[] yPoints = {HexagonHeight/4,3*HexagonHeight/4,HexagonHeight,3*HexagonHeight/4,HexagonHeight/4,0};
            ...
            if(j<64){
                ...
                }else if((j >= 4 && j < 12)|| (j>=20 && j<32) || (j>= 40 && j<56)){
                    if(j==20){
                        xMainCoord = 7*HexagonWidth/2 ;
                        yMainCoord = 0;
                    }
                    if(j==40){
                        xMainCoord = 9*HexagonWidth/2 ;
                        yMainCoord = 0;
                    }
                    if((j)%4==0){
                ...
                }else if((j >= 12 && j < 16) || (j >= 32 && j < 36) || (j >= 56 && j < 64)){
                    if(j==12){
                        xMainCoord = 3*HexagonWidth/2;
                        yMainCoord = 6*HexagonHeight/4;
                    }
                ...
                //Bigger Circle Algorithm
                
                if (j==64){
                    xMainCoord = (HexagonWidth*5) + (HexagonWidth/2);
                    OGx = xMainCoord;
                    yMainCoord = 0;
                    yNeeded = true;
                    ControllerCircle = 0;
