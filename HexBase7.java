...
public class HexBase7 extends JPanel{
    ...
    public HexBase7(String COLOR, int HexNum){
    ...
    public void paintComponent(Graphics g){
        ...
        super.paintComponent(g);
            ...
            int RegPatternNeeded = 2;
            int SidePatternNeeded = 0;
            int xIncrement = -HexagonWidth/2;
            int yIncrement = 3*HexagonHeight/4;           
            int HexagonCtr = 0;
            
            //Creating Base 7 Template
            ...
            for(int j = 0; j<(HexagonNumber-7);j++){
