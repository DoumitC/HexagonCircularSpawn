...
public class HexBase4 extends JPanel{
    ...
    public HexBase4(String COLOR, int HexNum){
    ...
    public void paintComponent(Graphics g){
        ...
        for(int j = 0; j<(HexagonNumber-4);j++){
            int[] xPoints = {HexagonWidth,HexagonWidth,HexagonWidth/2,0,0,HexagonWidth/2};
            int[] yPoints = {HexagonHeight/4,3*HexagonHeight/4,HexagonHeight,3*HexagonHeight/4,HexagonHeight/4,0};
            ...
            if(j<20){
                ...
                if (j==20){
                    xMainCoord = (HexagonWidth*3) + (HexagonWidth/2);
                    OGx = xMainCoord;
                    yMainCoord = 0;
                    yNeeded = true;
                    ControllerCircle = 0;
